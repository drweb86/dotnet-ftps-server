...
; Defines
!define PRODUCT_NAME "FTPS Server"
!ifndef PRODUCT_VERSION
!define PRODUCT_VERSION "0.0.0"
!endif
!define PRODUCT_PUBLISHER "Siarhei Kuchuk"
!define PRODUCT_WEB_SITE "https://github.com/drweb86/dotnet-ftps-server"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\bin\FtpsServerWindows.exe"
...
Section "MainSection" SEC01
  ...
  ${If} $MultiUser == "1"
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "DisplayIcon" "$INSTDIR\bin\FtpsServerWindows.exe"
  ...
  ${Else}
    ...
    WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "DisplayIcon" "$INSTDIR\bin\FtpsServerWindows.exe"
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\${PRODUCT_NAME}.lnk" "$INSTDIR\bin\FtpsServerWindows.exe"
  !insertmacro MUI_STARTMENU_WRITE_END
  
  ; Create desktop shortcut
  CreateShortcut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\bin\FtpsServerWindows.exe"
SectionEnd
