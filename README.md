...
Desktop and console apps are written in C# (.NET 10) for Windows and Linux. The **Android app is Kotlin** (`sources/android`) though both Avalonia-based Android implementation and Kotlin-based are available as sources.
...
| [Android (Kotlin)](./README_ANDROID.md) | [RuStore](https://www.rustore.ru/catalog/app/com.siarheikuchuk.ftpsserver) |
| [Ubuntu](./Ubuntu.md) |                                                                                   |
