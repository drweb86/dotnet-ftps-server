...
namespace FtpsServerAvalonia.Helpers;
...
internal static class ConnectionDetails
{
        ...
        bool android)
    {
        return ConnectionDetailsText.Build(
            ...
            CreateStrings(android));
    }

    public static ConnectionDetailsStrings CreateStrings(bool android) => new()
    {
        Title = Strings.ConnectionDetailsTitle,
        Intro = android ? Strings.ConnectionDetailsIntroAndroid : Strings.ConnectionDetailsIntroDesktop,
